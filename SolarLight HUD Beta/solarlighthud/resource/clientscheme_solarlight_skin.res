...
Scheme
{
	...
	Colors
	{
		//SolarLightHUD Colors

		"SolarTeamBLU"		"0 106 161 255"
		"SolarTeamRED"		"161 0 0 255"

		"SolarBG"		"0 0 0 200"
		"SolarBGBLUE"		"0 106 161 200"
		"SolarBGRED"		"161 0 0 200"
		
		
		"SolarMeterOrange"		"255 213 0 255"		//Color of some (not all) HUD meters. Used to be orange during development, but changed to yellow.
		
		"SolarMenuYellow"		"255 213 0 255"
		"SolarMenuYellowTransparent"		"255 213 0 200"
		
		"SolarMenuRed"			"161 0 0 255"  		//Fun fact, the menu used to have a red theme instead of yellow!
		"SolarMenuRedDarker"	"80 0 0 255" 
		"SolarMenuBlack"		"48 48 48 255"
		"SolarMenuBlack2"		"58 58 58 255"
		"SolarMenuWhite"		"255 255 255 255" //why did i even make this as a color when white clearly already exists pls help i dont know how to computer usidyhtgfilueshfdisal
		...
		"PartyMember2"	"99 232 167 255" //green for party members? overwatch ripoff confirmed
		"PartyMember3"	"99 232 167 255"
		"PartyMember4"	"99 232 167 255"
		"PartyMember5"	"99 232 167 255"
		"PartyMember6"	"99 232 167 255"
		...
		"HUDBlueTeam"		"0 106 161 127"
		"HUDRedTeam"		"161 0 0 127"
		"HUDSpectator"		"124 124 124 127"
		"HUDBlueTeamSolid"	"0 106 161 255"
		"HUDRedTeamSolid"	"161 0 0 255"
		...
		"ProgressBackground"	"255 255 255 51"
		"HealthBgGrey"		"72 72 72 255"
		
		"ProgressOffWhiteTransparent"	"255 255 255 128"
		
		"LabelDark"			"48 48 48 255"
		"LabelTransparent"	"109 109 109 180"
		
		"BuildMenuActive"	"248 248 248 255"
	...
	Borders
	{
		...
		SolarMainMenuButtonHighlight
		{
			"bordertype"			"scalable_image"
			"backgroundtype"		"2"
			
			"image"					"replay/thumbnails/mainmenu_button_highlight"
		}
		...
		TFFatLineBorderRedBGOpaque
		{
			...
			"image"					"../vgui/replay/thumbnails/bgredtransparent"
			"src_corner_height"		"23"				// pixels inside the image
			"src_corner_width"		"23"
			"draw_corner_width"		"0"				// screen size of the corners ( and sides ), proportional
			"draw_corner_height" 	"0"	
		...
		TFFatLineBorderRedBG
		{
			...
			"image"					"../vgui/replay/thumbnails/bgred"
			"src_corner_height"		"23"				// pixels inside the image
			"src_corner_width"		"23"
			"draw_corner_width"		"0"				// screen size of the corners ( and sides ), proportional
			"draw_corner_height" 	"0"	
		...
		TFFatLineBorderBlueBG
		{
			...
			"image"					"../vgui/replay/thumbnails/bgblue"
			"src_corner_height"		"23"				// pixels inside the image
			"src_corner_width"		"23"
			"draw_corner_width"		"0"				// screen size of the corners ( and sides ), proportional
			"draw_corner_height" 	"0"	
		...
		TFFatLineBorderBlueBGMoreOpaque
		{
			...
			"image"					"../vgui/replay/thumbnails/bgbluetransparent"
			"src_corner_height"		"23"				// pixels inside the image
			"src_corner_width"		"23"
			"draw_corner_width"		"0"				// screen size of the corners ( and sides ), proportional
			"draw_corner_height" 	"0"	
